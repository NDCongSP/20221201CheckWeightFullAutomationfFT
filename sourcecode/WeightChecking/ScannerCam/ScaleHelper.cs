...
namespace ScannerCam
{
    ...
    public class ScaleHelper : IDisposable
    {
        ...
        public string Ip = "192.168.80.20";
        ...
        private string _value = "", _valueNew = "";
                    ...
                    using (NetworkStream _stream = new NetworkStream(sender))
                    {
                        ...
                        if (_stream != null)
                        {
                            using (StreamReader _reader = new StreamReader(_stream))
                            {
                                if (_reader != null)
                                {
                                    while (_reader.Read(buffer, 0, 1) > 0)
                                    {
                                        value += buffer[0];
    ...
    public class ScaleValueChangedEventArgs : EventArgs
    {
        ...
        public ScaleValueChangedEventArgs(string value)
        {
            this._value = value;
        }
